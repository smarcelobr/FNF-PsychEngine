...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["it's spooky month",			"Beat Skid Week on Hard with no Misses.",			'week1_nomiss',			false],
		["Mario is angry with you",		"Beat Week J on Hard with no Misses.",				'week2_nomiss',			false],
		["No more balls",				"Beat Week Ball on Hard with no Misses.",    		'week3_nomiss',			false],
		["Call Me The Jorge",			"Beat Reverse Week on Hard with no Misses.",		'week4_nomiss',			false],
