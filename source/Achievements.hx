...
class Achievements {
	public static var achievementShits:Array<Dynamic> = [//Name, Description, Achievement save tag, Unlocks after, Hidden achievement
		...
		["it's spooky month",		"Beat Skid Week on Hard with no Misses.",				'week1_nomiss',			'week1', 		false],
		["Mario is angry with you",				"Beat Week J on Hard with no Misses.",				'week2_nomiss',         'week2', 		false],
		["No more balls",			"Beat Week Ball on Hard with no Misses.",				'week3_nomiss',			'week3', 		false],
		["Call Me The Jorge",					"Beat Reverse Week on Hard with no Misses.",				'week4_nomiss',			'week4', 		false],
